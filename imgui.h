...
namespace ImGui
{
    ...
    IMGUI_API void          Separator(ImGuiSeparatorFlags flags = 0);                       // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
